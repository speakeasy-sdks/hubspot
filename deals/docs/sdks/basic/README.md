...
<!-- UsageSnippet language="go" operationID="get-/crm/v3/objects/deals/{dealId}_getById" method="get" path="/crm/v3/objects/deals/{dealId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Basic.GetCrmV3ObjectsDealsDealIDGetByID(ctx, operations.GetCrmV3ObjectsDealsDealIDGetByIDRequest{
        DealID: "<id>",
    }, operations.GetCrmV3ObjectsDealsDealIDGetByIDSecurity{
...
<!-- UsageSnippet language="go" operationID="delete-/crm/v3/objects/deals/{dealId}_archive" method="delete" path="/crm/v3/objects/deals/{dealId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Basic.DeleteCrmV3ObjectsDealsDealIDArchive(ctx, operations.DeleteCrmV3ObjectsDealsDealIDArchiveSecurity{
        Oauth2: deals.Pointer("<YOUR_OAUTH2_HERE>"),
    }, "<id>")
    if err != nil {
        log.Fatal(err)
...
<!-- UsageSnippet language="go" operationID="patch-/crm/v3/objects/deals/{dealId}_update" method="patch" path="/crm/v3/objects/deals/{dealId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Basic.PatchCrmV3ObjectsDealsDealIDUpdate(ctx, operations.PatchCrmV3ObjectsDealsDealIDUpdateSecurity{
        Oauth2: deals.Pointer("<YOUR_OAUTH2_HERE>"),
    }, "<id>", components.SimplePublicObjectInput{
...
<!-- UsageSnippet language="go" operationID="get-/crm/v3/objects/deals_getPage" method="get" path="/crm/v3/objects/deals" -->
```go
package main
...
func main() {
    ...
    res, err := s.Basic.GetCrmV3ObjectsDealsGetPage(ctx, operations.GetCrmV3ObjectsDealsGetPageRequest{}, operations.GetCrmV3ObjectsDealsGetPageSecurity{
        Oauth2: deals.Pointer("<YOUR_OAUTH2_HERE>"),
    })
    if err != nil {
        log.Fatal(err)
...
<!-- UsageSnippet language="go" operationID="post-/crm/v3/objects/deals_create" method="post" path="/crm/v3/objects/deals" -->
```go
package main
...
func main() {
    ...
    }, operations.PostCrmV3ObjectsDealsCreateSecurity{
        Oauth2: deals.Pointer("<YOUR_OAUTH2_HERE>"),
    })
    if err != nil {
        log.Fatal(err)

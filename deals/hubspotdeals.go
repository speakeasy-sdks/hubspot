...
// Generated from OpenAPI doc version v3 and generator version 2.721.3
...
func New(opts ...SDKOption) *HubSpotDeals {
	sdk := &HubSpotDeals{
		SDKVersion: "0.1.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.1.0 2.721.3 v3 github.com/speakeasy-sdks/hubspot-go/deals",

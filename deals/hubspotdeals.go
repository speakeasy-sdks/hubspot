...
// Generated from OpenAPI doc version v3 and generator version 2.716.10
...
type SDKOption func(*HubSpotDeals)
...
func New(opts ...SDKOption) *HubSpotDeals {
	sdk := &HubSpotDeals{
		SDKVersion: "0.1.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.1.0 2.716.10 v3 github.com/speakeasy-sdks/hubspot-go/deals",
	...
	sdk.Basic = newBasic(sdk, sdk.sdkConfiguration, sdk.hooks)
	sdk.PublicObject = newPublicObject(sdk, sdk.sdkConfiguration, sdk.hooks)
	sdk.Gdpr = newGdpr(sdk, sdk.sdkConfiguration, sdk.hooks)

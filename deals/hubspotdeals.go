...
func New(opts ...SDKOption) *HubSpotDeals {
	sdk := &HubSpotDeals{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.2",
			GenVersion:        "2.291.0",
			UserAgent:         "speakeasy-sdk/go 0.0.2 2.291.0 v3 github.com/speakeasy-sdks/hubspot-go/deals",
			Hooks:             hooks.New(),
		},
	}
	...
	sdk.Basic = newBasic(sdk.sdkConfiguration)

	sdk.PublicObject = newPublicObject(sdk.sdkConfiguration)

	sdk.Gdpr = newGdpr(sdk.sdkConfiguration)
